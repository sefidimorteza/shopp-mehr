<template>
  <div>
    <bannerVue :banners="data?.data.banners" :position="BannerPosition.بالای_اسلایدر" />
    <div class="row mb-5">
      ...
      <div class="col-lg-4">
        <div class="row">
          <div class="col-lg-12 col-6">
            <bannerVue :banners="data?.data.banners" :position="BannerPosition.سمت_چپ_اسلایدر" />
          </div>
        </div>
      </div>
    </div>
    ...
    <amazingProductsVue :products="data?.data.amazingProducts" />
...
import amazingProductsVue from "~/components/home/amazingProducts.vue";
